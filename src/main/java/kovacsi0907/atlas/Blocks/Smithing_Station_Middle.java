...
public class Smithing_Station_Middle extends HorizontalFacingBlock {
    SmithingStationBlock parent;

    protected Smithing_Station_Middle(Settings settings){
        super(settings);
        setDefaultState(getDefaultState().with(Properties.HORIZONTAL_FACING, Direction.NORTH));
    }
    protected Smithing_Station_Middle(Settings settings, SmithingStationBlock parent, Direction dir) {
        super(settings);
