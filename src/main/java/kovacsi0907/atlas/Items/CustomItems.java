...
public class CustomItems {
    ...
    public static Item SILVER_ORE_ITEM=new BlockItem(SILVER_ORE, new FabricItemSettings());
    public static  Block TIN_ORE = new Block(FabricBlockSettings.of(Material.METAL).strength(1.0f).resistance(6.0f).requiresTool());
    public static  Item TIN_ORE_ITEM=new BlockItem(TIN_ORE, new FabricItemSettings());
